...
class CocoDataset(preprocess.SegmentationDataset):
    ...
    def map_source_class_id(self, source_class_id):
        ...
        if source_class_id in self.class_from_source_map:
            ...
            print("invalid class input to source map: ", source_class_id)
            return -1
    ...
    def load_coco(self, dataset_dir, subset, year, class_ids=None,
        ...
        # print("get category idsxxxxxxxxxxxx: ", coco.getCatIds())
    ...
    def create_mask(self, image, image_id):
        ...
        for annotation in annotations:
            category_id = "coco.{}".format(annotation['category_id'])
            class_id = self.map_source_class_id(category_id)
            if class_id:
        ...
        """
            Write images, instance masks to local along with detections.
        """
